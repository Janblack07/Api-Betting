...
class ApiUsageController extends Controller
{
    ...
    #[OA\Get(
        ...
        description: 'Permite al administrador consultar el historial de consumo de créditos, requests usados y requests restantes.',
        security: [['sanctum' => []]],
        ...
        responses: [
            new OA\Response(response: 200, description: 'Historial de consumo obtenido correctamente'),
    ...
    #[OA\Get(
        ...
        description: 'Devuelve resumen mensual de créditos usados, requests realizados, requests restantes y consumo agrupado.',
        security: [['sanctum' => []]],
        tags: ['Admin API Usage'],
        parameters: [
            new OA\Parameter(
        ...
        responses: [
            new OA\Response(response: 200, description: 'Resumen de consumo obtenido correctamente'),
            new OA\Response(response: 401, description: 'No autenticado'),
            new OA\Response(response: 403, description: 'No autorizado'),
        ]
    )]
